...
[![NPM version](http://img.shields.io/npm/v/@a-2-c-2-anpm/labore-voluptatibus-consectetur.svg?style=flat-square)](https://www.npmjs.org/package/@a-2-c-2-anpm/labore-voluptatibus-consectetur)
...
![Tailing Slonik logs](./.README/@a-2-c-2-anpm/labore-voluptatibus-consectetur-log-tailing.gif)

(The above GIF shows Slonik producing [query logs](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#logging). Slonik produces logs using [Roarr](https://github.com/gajus/roarr). Logs include stack trace of the actual query invocation location and values used to execute the query.)
...
* [Slonik](#@a-2-c-2-anpm/labore-voluptatibus-consectetur)
    * [Sponsors](#sponsors)
    * [Principles](#principles)
    * [Features](#features)
    * [Contents](#contents)
    * [About Slonik](#about-@a-2-c-2-anpm/labore-voluptatibus-consectetur)
    ...
    * [How are they different?](#how-are-they-different)
        * [`pg` vs `@a-2-c-2-anpm/labore-voluptatibus-consectetur`](#pg-vs-@a-2-c-2-anpm/labore-voluptatibus-consectetur)
        * [`pg-promise` vs `@a-2-c-2-anpm/labore-voluptatibus-consectetur`](#pg-promise-vs-@a-2-c-2-anpm/labore-voluptatibus-consectetur)
        * [`postgres` vs `@a-2-c-2-anpm/labore-voluptatibus-consectetur`](#postgres-vs-@a-2-c-2-anpm/labore-voluptatibus-consectetur)
...
Read: [The History of Slonik, the PostgreSQL Elephant Logo](https://www.vertabelo.com/blog/notes-from-the-lab/the-history-of-@a-2-c-2-anpm/labore-voluptatibus-consectetur-the-postgresql-elephant-logo)
...
} from '@a-2-c-2-anpm/labore-voluptatibus-consectetur';
...
This means that the only way to run a query is by constructing it using [`sql` tagged template literal](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#value-placeholders-tagged-template-literals), e.g.
...
Other configurations are available through the [`clientConfiguration` parameter](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#api).
...
> **Note:** If you are new to Slonik, then you should read [Integrating Slonik with Express.js](https://dev.to/gajus/integrating-@a-2-c-2-anpm/labore-voluptatibus-consectetur-with-expressjs-33kn).
 ...
 * @property interceptors An array of [Slonik interceptors](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#interceptors).
 ...
 * @property typeParsers An array of [Slonik type parsers](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#type-parsers).
 */
...
Check out [`@a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-preset`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-preset) for an opinionated collection of interceptors.
...
### <code>pg</code> vs <code>@a-2-c-2-anpm/labore-voluptatibus-consectetur</code>
...
### <code>pg-promise</code> vs <code>@a-2-c-2-anpm/labore-voluptatibus-consectetur</code>
...
* Slonik implements [interceptor API](#interceptors) (middleware). Middlewares allow to modify connection handling, override queries and modify the query results. Example Slonik interceptors include [field name transformation](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-field-name-transformation), [query normalization](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-normalisation) and [query benchmarking](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-benchmarking).

Note: Author of `pg-promise` has [objected to the above claims](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur/issues/122). I have removed a difference that was clearly wrong. I maintain that the above two differences remain valid differences: even though `pg-promise` might have substitute functionality for variable interpolation and interceptors, it implements them in a way that does not provide the same benefits that Slonik provides, namely: guaranteed security and support for extending library functionality using multiple plugins.

Other differences are primarily in how the equivalent features are implemented, e.g.

|`pg-promise`|Slonik|
|---|---|
|[Custom type formatting](https://github.com/vitaly-t/pg-promise#custom-type-formatting).|Not available in Slonik. The current proposal is to create an interceptor that would have access to the [query fragment constructor](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur/issues/21).|
|[formatting filters](https://github.com/vitaly-t/pg-promise#nested-named-parameters)|Slonik tagged template [value expressions](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#value-placeholders) to construct query fragments and bind parameter values.|
|[Query files](https://github.com/vitaly-t/pg-promise#query-files).|Use [`@a-2-c-2-anpm/labore-voluptatibus-consectetur-sql-tag-raw`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-sql-tag-raw).|
|[Tasks](https://github.com/vitaly-t/pg-promise#tasks).|Use [`pool.connect`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#create-connection).|
|Configurable transactions.|Not available in Slonik. Track [this issue](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur/issues/30).|
|Events.|Use [interceptors](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#interceptors).|
...
### <code>postgres</code> vs <code>@a-2-c-2-anpm/labore-voluptatibus-consectetur</code>
...
import { createPool } from '@a-2-c-2-anpm/labore-voluptatibus-consectetur';
...
|Name|Description|
|---|---|
|[`@a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-field-name-transformation`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-field-name-transformation)|Transforms Slonik query result field names.|
|[`@a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-benchmarking`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-benchmarking)|Benchmarks Slonik queries.|
|[`@a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-cache`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-cache)|Caches Slonik queries.|
|[`@a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-logging`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-logging)|Logs Slonik queries.|
|[`@a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-normalisation`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-normalisation)|Normalises Slonik queries.|
...
You can also use the [`pgvector` NPM package](https://github.com/pgvector/pgvector-node/?tab=readme-ov-file#@a-2-c-2-anpm/labore-voluptatibus-consectetur) to achieve the same result.
...
1. Add a [result parser interceptor](#result-parser-interceptor) during @a-2-c-2-anpm/labore-voluptatibus-consectetur initiialization
...
> [!WARNING]
> Due to the way that Slonik internally represents SQL fragments, your query must not contain `$@a-2-c-2-anpm/labore-voluptatibus-consectetur_` literals.
...
SAVEPOINT @a-2-c-2-anpm/labore-voluptatibus-consectetur_savepoint_1;
...
SAVEPOINT @a-2-c-2-anpm/labore-voluptatibus-consectetur_savepoint_1;
INSERT INTO qux (quux) VALUES ('corge');
ROLLBACK TO SAVEPOINT @a-2-c-2-anpm/labore-voluptatibus-consectetur_savepoint_1;
COMMIT;
```
...
SAVEPOINT @a-2-c-2-anpm/labore-voluptatibus-consectetur_savepoint_1;
INSERT INTO qux (quux) VALUES ('corge');
SAVEPOINT @a-2-c-2-anpm/labore-voluptatibus-consectetur_savepoint_2;
INSERT INTO uier (grault) VALUES ('garply');
ROLLBACK TO SAVEPOINT @a-2-c-2-anpm/labore-voluptatibus-consectetur_savepoint_2;
ROLLBACK TO SAVEPOINT @a-2-c-2-anpm/labore-voluptatibus-consectetur_savepoint_1;
ROLLBACK;
```
...
* [`@@a-2-c-2-anpm/labore-voluptatibus-consectetur/migrator`](https://www.npmjs.com/package/@@a-2-c-2-anpm/labore-voluptatibus-consectetur/migrator)
...
Query-level logging can be added using [`@a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-logging`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-logging) interceptor.

### Capture stack trace

Note: Requires [`@a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-logging`](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur-interceptor-query-logging).
...
{
  "context": {
    "package": "@a-2-c-2-anpm/labore-voluptatibus-consectetur",
    "namespace": "@a-2-c-2-anpm/labore-voluptatibus-consectetur",
    "logLevel": 20,
    ...
    "stackTrace": [
      "/node_modules/@a-2-c-2-anpm/labore-voluptatibus-consectetur/dist:162:28",
      "/node_modules/@a-2-c-2-anpm/labore-voluptatibus-consectetur/dist:314:12",
      "/node_modules/@a-2-c-2-anpm/labore-voluptatibus-consectetur/dist:361:20",
      "/node_modules/@a-2-c-2-anpm/labore-voluptatibus-consectetur/dist/utilities:17:13",
...
}
{
  "context": {
    ...
    "stackTrace": [
      "/node_modules/@a-2-c-2-anpm/labore-voluptatibus-consectetur/dist:162:28",
      "/node_modules/@a-2-c-2-anpm/labore-voluptatibus-consectetur/dist:285:12",
      "/node_modules/@a-2-c-2-anpm/labore-voluptatibus-consectetur/dist/utilities:17:13",
...
1. Use [`sql` helper to construct the queries](https://github.com/a-2-c-2-anpm/labore-voluptatibus-consectetur#tagged-template-literals).
...
```bash
docker run --name @a-2-c-2-anpm/labore-voluptatibus-consectetur-test --rm -it -e POSTGRES_HOST_AUTH_METHOD=trust -p 5432:5432 postgres -N 1000
```
